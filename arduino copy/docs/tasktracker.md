...
## Задача: Переписать stepperHome на planner.setTarget()
- **Статус**: Завершена
- **Описание**: Перевести алгоритм индивидуального хоминга на использование `planner.setTarget()` для устранения асинхронных состояний и раннего завершения.
- **Шаги выполнения**:
  - [x] Согласовать решение с заказчиком (вариант 2)
  - [x] Спроектировать алгоритм на базе `setTarget` (pre-backoff → move-away → seek → final backoff)
  - [x] Реализовать новую версию `stepperHome()`
  - [x] Обновить документацию (changelog.md, tasktracker.md)
  - [x] Провести внутренний code review
  - [ ] Тестирование на стенде
- **Зависимости**: Предыдущие улучшения логики хоминга и структуры конфигурации
